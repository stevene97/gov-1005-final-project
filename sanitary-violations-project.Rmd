...
# Making two tables showing each of the establishments' violations
...
```{r tab_3}
# Summarizing the worst sanitary violations around Harvard Square with a dot map, with the radius of the dot signifying how many violations the establishment has
